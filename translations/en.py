...
translations = {
    ...
    "auto_translated_from": "auto-translated from {lang}",
    ...
    "settings_language_desc": "Set the permanent language for your account. This is saved to your profile and used on every device.",
    "settings_lang_saved": "Language updated.",
    "settings_profile_title": "Public profile",
    "settings_profile_desc": "Anyone with this link can view your garden.",
    "share_public_profile": "Share my garden",
    "share_plant": "Share plant",
    "Share": "Share",
    ...
    "freetext_label_qr_field": "QR code (optional)",
    "freetext_label_qr_placeholder": "URL or text to encode",
    "freetext_label_qr_help": "Leave empty for no QR code.",
